/* Copyright 2011 David Simmons http://cafbit.com/entry/implementing_des
 * 
...
public class DES {
     ...
     */
    private static final byte[]   FP        = { 40, 8, 48, 16, 56, 24, 64, 32,
     ...
     * value.
     */
    private static final byte[]   E         = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7,
     ...
     */
    private static final byte[]   P         = { 16, 7, 20, 21, 29, 12, 28, 17,
     ...
     */
    private static final byte[]   PC1       = { 57, 49, 41, 33, 25, 17, 9, 1,
     ...
     * 48-bit subkeys.
     */
    private static final byte[]   PC2       = { 14, 17, 11, 24, 1, 5, 3, 28,
            15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2, 41, 52,
            31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46,
            42, 50, 36, 29, 32             };
     ...
     * 16 steps.
     */
    private static final byte[]   rotations = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2,
            2, 2, 2, 2, 2, 1               };
     ...
     * instead of longs.
     */
    public static void encryptBlock(byte[] message, int messageOffset,
    ...
    private static byte[] parseBytes(String s) {
        ...
        for (int i = 0; i < s.length(); i += 2) {
            ba[i / 2] = (byte) (charToNibble(s.charAt(i)) << 4 | charToNibble(s
                    .charAt(i + 1)));
        }
        return ba;
    }
    ...
    public static void main(String[] args) {
        ...
        // DES calculations:
        // http://orlingrabbe.com/des.htm
        test(parseBytes("0123456789ABCDEF"), parseBytes("85E813540F0AB405"),
