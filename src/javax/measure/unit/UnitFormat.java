...
public abstract class UnitFormat extends Format {
    ...
    static {
        ...
        DEFAULT.label(SI.CELSIUS, "â„ƒ");
        DEFAULT.alias(SI.CELSIUS, "Â°C");
        ASCII.label(SI.CELSIUS, "Celsius");
        for (int i = 0; i < PREFIXES.length; i++) {
            DEFAULT.label(SI.CELSIUS.transform(CONVERTERS[i]), PREFIXES[i] + "â„ƒ");
            DEFAULT.alias(SI.CELSIUS.transform(CONVERTERS[i]), PREFIXES[i] + "Â°C");
    ...
    static {
        ...
        DEFAULT.label(NonSI.DEGREE_ANGLE, "Â°");
        ...
        DEFAULT.label(NonSI.ANGSTROM, "Ã…");
        ...
        DEFAULT.label(NonSI.RANKINE, "Â°R");
        ASCII.label(NonSI.RANKINE, "degree_rankine");
        DEFAULT.label(NonSI.FAHRENHEIT, "Â°F");
        ...
        DEFAULT.label(SI.MICRO(NonSI.LITRE), "ÂµL");
